<template>
  <div>
    ...
    <ul>
      ...
      <li>按住CTRL/shift键点击头像用户名区域（或者同时按CTRL+shift）：更改头像/背景图链接</li>
      <li>同时按CTRL+空格：开启/关闭纯净模式（使用默认头像，关闭背景图）</li>
      <li>我的网盘：存储各种奇奇怪怪的文件</li>
      <li>头像编辑：裁剪图片，预览和保存裁剪后的图片</li>
      <li>笔记格式修改：修改md格式（换行/图片格式/标题级数...）</li>
    </ul>
  </div>
</template>
